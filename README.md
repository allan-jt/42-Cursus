...
Hello all! Here you'll find all the projects I've done at 42 Abu Dhabi, which is a free coding that's part of the global 42 network. Fellow students can also find my projects on the Intra by searching for athekkep.
...
- Projects are grouped together in--what we colloquially refer to as--'circles' along the lines of difficulty/complexity. To progress to different circles, you must complete all the projects and the exam in the current circle.
...
- Exams are graded out of 100 and a full score is needed to pass.


### Current progress
| Project no. | Circle no. | Project name | Language | Grade |
| --- | --- | --- | --- | --- |
